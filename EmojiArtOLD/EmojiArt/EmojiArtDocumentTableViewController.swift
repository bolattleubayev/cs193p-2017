...
class EmojiArtDocumentTableViewController: UITableViewController {
    ...
    // we have only 1 section, return 1
    ...
    @IBAction func newEmojiArt(_ sender: UIBarButtonItem) {
        emojiArtDocuments += ["Unitiled".madeUnique(withRespectTo: emojiArtDocuments)] // madeUniqe adds unique number to differ from other elements of the array
